...
export default function HelpersUpdateForm(props) {
  const {
    id: idProp,
    helpers,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = helpersRecord
      ? { ...initialValues, ...helpersRecord }
      : initialValues;
    ...
    setExperienceYears(cleanValues.experienceYears);
    setExperienceKids(cleanValues.experienceKids);
    setJobType(cleanValues.jobType);
    setErrors({});
  };
  const [helpersRecord, setHelpersRecord] = React.useState(helpers);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Helpers, idProp) : helpers;
      setHelpersRecord(record);
    };
    queryData();
  }, [idProp, helpers]);
  React.useEffect(resetStateValues, [helpersRecord]);
  const validations = {
    name: [],
    phone: [],
    email: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Helpers.copyOf(helpersRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "HelpersUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
